...
/****** 
		PROCEDIMIENTO PARA REGISTRAR UNA ACTIVIDAD REALIZADA EN A BASE DE DATOS
		FECHA: 8/5/2017 2:40 PM
******/
USE [HPSC_SERVCORP]
GO
SET ANSI_NULLS ON
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[ANADIR_ACTIVIDAD]
	@ac_tipo AS varchar(250) ,
	@ac_inicio AS datetime ,
	@ac_fin AS datetime,
	@ac_fk_incidente AS varchar(500) ,
	@ac_fk_empleado AS varchar(350)
AS
BEGIN
	IF ((SELECT COUNT(AC_ID) FROM ACTIVIDAD) = 0)
		BEGIN
			INSERT INTO ACTIVIDAD VALUES(1, @ac_tipo, @ac_inicio, @ac_fin, @ac_fk_incidente, @ac_fk_empleado);
		END
  	ELSE
		BEGIN
			INSERT INTO ACTIVIDAD VALUES((SELECT MAX(AC_ID) from ACTIVIDAD)+1, @ac_tipo, @ac_inicio, @ac_fin, @ac_fk_incidente, @ac_fk_empleado);
		END
END
...
/****** 
		PROCEDIMIENTO PARA CONSULTAR LAS ACTIVIDADES REALIZADAS EN UN INCIDENTE
		FECHA: 8/5/2017 3:10 PM
******/
USE [HPSC_SERVCORP]
GO
SET ANSI_NULLS ON
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[CONSULTAR_ACTIVIDADES]
	@ac_fk_incidente AS varchar(500)
AS
BEGIN
	SELECT A.AC_ID, A.AC_TIPO, A.AC_FECHAINICIO, A.AC_FECHAFIN, E.E_NOMBRE1, E.E_APELLIDO1 
	FROM INCIDENTE I, EMPLEADO E, ACTIVIDAD A
	WHERE E.E_CORREO = A.AC_FK_EMPLEADO and A.AC_FK_INCIDENTE = I.I_ID AND I.I_ID = @ac_fk_incidente;
END	



/****** 
		PROCEDIMIENTO PARA ELIMINAR UNA ACTIVIDAD DE LA BASE DE DATOS
		FECHA: 8/5/2017 5:57 PM
******/
USE [HPSC_SERVCORP]
GO
SET ANSI_NULLS ON
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[ELIMINAR_ACTIVIDAD]
  @ac_id AS int 
AS
BEGIN
	DELETE FROM [dbo].[ACTIVIDAD] WHERE [AC_ID] = @ac_id
END
...
/****** 
		PROCEDIMIENTO PARA CONSULTAR LA CANTIDAD DE INCIDENTES POR TIPO DE INCIDENTE
		FECHA: 10/5/2017 11:40 AM
******/
USE [HPSC_SERVCORP]
GO
SET ANSI_NULLS ON
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[CANTIDAD_INCIDENTES_REACTIVO]
AS
BEGIN

	SELECT COUNT(*)
	FROM INCIDENTE 
	WHERE I_TIPOSERVICIO = 'Soporte reactivo';
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[CANTIDAD_INCIDENTES_PREVENTIVO]
AS
BEGIN

	SELECT COUNT(*)
	FROM INCIDENTE 
	WHERE I_TIPOSERVICIO = 'Soporte preventivo';
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[CANTIDAD_INCIDENTES_IMPLEMENTACION]
AS
BEGIN

	SELECT COUNT(*)
	FROM INCIDENTE 
	WHERE I_TIPOSERVICIO = 'Implementación';
...
/****** 
		PROCEDIMIENTO PARA CONSULTAR LA CANTIDAD DE INCIDENTES POR TIPO DE IMPACTO
		FECHA: 10/5/2017 11:52 AM
******/
USE [HPSC_SERVCORP]
GO
SET ANSI_NULLS ON
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[CANTIDAD_INCIDENTES_ICRITICO]
AS
BEGIN

	SELECT COUNT(*)
	FROM INCIDENTE 
	WHERE I_IMPACTO = 'Crítico';
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[CANTIDAD_INCIDENTES_IMENOR]
AS
BEGIN

	SELECT COUNT(*)
	FROM INCIDENTE 
	WHERE I_IMPACTO = 'Menor';
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[CANTIDAD_INCIDENTES_IMODERADO]
AS
BEGIN

	SELECT COUNT(*)
	FROM INCIDENTE 
	WHERE I_IMPACTO = 'Moderado';
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[CANTIDAD_INCIDENTES_ISIGNIFICATIVO]
AS
BEGIN

	SELECT COUNT(*)
	FROM INCIDENTE 
	WHERE I_IMPACTO = 'Significativo';
END



/****** 
		PROCEDIMIENTO PARA CONSULTAR LA CANTIDAD DE INCIDENTES POR TIPO DE URGENCIA
		FECHA: 10/5/2017 11:58 AM
******/
USE [HPSC_SERVCORP]
GO
SET ANSI_NULLS ON
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[CANTIDAD_INCIDENTES_UALTA]
AS
BEGIN

	SELECT COUNT(*)
	FROM INCIDENTE 
	WHERE I_URGENCIA = 'Alta';
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[CANTIDAD_INCIDENTES_UMEDIA]
AS
BEGIN

	SELECT COUNT(*)
	FROM INCIDENTE 
	WHERE I_URGENCIA = 'Media';
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[CANTIDAD_INCIDENTES_UCRITICA]
AS
BEGIN
	SELECT COUNT(*)
	FROM INCIDENTE 
	WHERE I_URGENCIA = 'Crítica';
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[CANTIDAD_INCIDENTES_UBAJA]
AS
BEGIN

	SELECT COUNT(*)
	FROM INCIDENTE 
	WHERE I_URGENCIA = 'Baja';

END

/****** 
		PROCEDIMIENTOS PARA CONSULTAR LA CANTIDAD DE INCIDENTES POR ESTATUS
		FECHA: 10/5/2017 12:12 PM
******/
USE [HPSC_SERVCORP]
GO
SET ANSI_NULLS ON
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[CANTIDAD_INCIDENTES_TOTAL]
AS
BEGIN

	SELECT COUNT(*) AS TOTALINCIDENTES
	FROM INCIDENTE;
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[CANTIDAD_INCIDENTES_ATENDIDOS]
AS
BEGIN

	SELECT COUNT(*) AS ATENDIDOS
	FROM INCIDENTE
	WHERE I_FECHAATENCION IS NOT NULL AND I_FECHAFINSERVICIO IS NULL;
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[CANTIDAD_INCIDENTES_SIN_ATENDER]
AS
BEGIN

	SELECT COUNT(*) AS SIN_ATENDER
	FROM INCIDENTE
	WHERE I_FECHAATENCION IS NULL AND I_FECHAFINSERVICIO IS NULL;
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[CANTIDAD_INCIDENTES_FINALIZADOS]
AS
BEGIN

	SELECT COUNT(*) AS FINALIZADOS
	FROM INCIDENTE
	WHERE I_FECHAATENCION IS NOT NULL AND I_FECHAFINSERVICIO IS NOT NULL;
