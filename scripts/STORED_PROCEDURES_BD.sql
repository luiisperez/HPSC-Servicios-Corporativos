...
BEGIN
		BEGIN
			INSERT INTO EQUIPO VALUES(@eq_serial, @eq_numequipo, @eq_categoria, @eq_marca, @eq_modelo, NULL);
		END
END
...
BEGIN
		BEGIN
			SELECT E.EQ_SERIAl, E.EQ_NUMEROEQUIPO, E.EQ_CATEGORIA, E.EQ_MARCA, E.EQ_MODELO, C.C_NOMBRE_EMPRESA
