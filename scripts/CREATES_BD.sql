...
CREATE TABLE dbo.ACTIVIDAD(
	...
	AC_FK_INCIDENTE				varchar(500) NOT NULL,
...
CREATE TABLE dbo.INCIDENTE(
	...
	I_FK_CONTRATO 				varchar(500) NOT NULL,
	I_FK_SERVICIO				varchar(500) NOT NULL,
...
CREATE TABLE dbo.FERIADO(
	F_ID						int NOT NULL,
	F_DESCRIPCION				varchar(500) NOT NULL,
	F_DIA						int NOT NULL,
	F_MES						int NOT NULL,
	CONSTRAINT PK_FERIADO PRIMARY KEY (F_ID)
);