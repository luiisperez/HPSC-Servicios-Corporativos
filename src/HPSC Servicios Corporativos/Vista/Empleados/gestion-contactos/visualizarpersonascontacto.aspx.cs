...
{
    public partial class visualizarpersonascontacto : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    try
                    {
                        ConsultarTodasPersonasContacto cmd = FabricaComando.ComandoConsultarTodasPersonasContacto();
                        cmd.ejecutar();
                    ...
                    {
                        string script = "alert(\"No se pudo cargar la información en la página, intente resfrescar\");";
        ...
        protected void repPeople_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            if (botonpresionado.ID.Equals("Modificar"))
            {
                ...
                Response.Redirect("/Vista/Empleados/gestion-contactos/modificarpersonacontacto.aspx?id=" + id.Text);
            }
