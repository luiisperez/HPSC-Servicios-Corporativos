<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="visualizarproductos.aspx.cs" Inherits="HPSC_Servicios_Corporativos.Vista.Empleados.gestion_productos.visualizarproductos" %>
                        ...
                        <div class="box">
                            <div class="box-body">
                                    <table id="tabla" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th style="width:120px">N° de producto</th>
                                            ...
                                            <tbody id="contenidotabla">
                                                 <asp:Repeater ID="repPeople" runat="server" OnItemCommand="repPeople_ItemCommand">
                                                    <ItemTemplate>
                                                            <tr id="<%# Eval("numeroequipo") %>">
                                                                <td><asp:Label ID="numeq" runat="server" Text='<%# Eval("numeroequipo") %>' ReadOnly="True" BorderStyle="None" /></td>
                                                                <td><%# Eval("categoria") %></td>
                                                                <td><%# Eval("marca") %></td>
                                                                <td><%# Eval("modelo") %></td>
                                                                <td style="text-align:center">
                                                                    <asp:ImageButton ID="Modificar" runat="server" Text="Eliminar" ImageUrl="~/Vista/Common/img/modificar.ico" Height="25px" Width="25px" ToolTip="Modificar producto" />
                                                                </td>
                                                            </tr>              
                                                    </ItemTemplate>
                                                 </asp:Repeater>
