<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modificarequipo.aspx.cs" Inherits="HPSC_Servicios_Corporativos.Vista.Empleados.gestion_equipos.modificarequipo" %>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="margin-top:30px;margin-left:50px">
                                            ...
                                            <div class="col-xs-6">
                                                ...
                                                <asp:DropDownList ID="listadoestatus" class="form-control" runat="server" Height="30px" Width="70%">
