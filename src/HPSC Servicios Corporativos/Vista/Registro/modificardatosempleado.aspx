...
<body id="page-top">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navbar-expanded" style="background-color:black; height:100px">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="/Vista/Index/postlogin.aspx">
    ...
    <section class="bg-gray" id="formulario" style="background-image: url('assets/img/registro-bg.jpg');background-size:100% 100vh;background-repeat:no-repeat;height:736px">
        <div class="container text-center wow fadeIn">
            <div class="row">
                <div class="col-lg-12">
                    <h2 style="color:white">Modificación de usuario</h2>
                </div>
            </div>
            <div class="row content-row" style="margin-left:320px">
                <form style="background-color:lightgray;width:500px;border-radius: 15px;" id="formregistro" runat="server" >
                    ...
                    <asp:Panel ID="empform" runat="server" Height="350px">
                        <div class="col-md-13" style="background-color:lightgray;margin-top:10px">
                            <div>
                                ...
                                <div class="col-md-3">
                                    <asp:TextBox ID="correoemp" runat="server" TextMode="Email" Width="230px" MaxLength="30" Enabled="False"></asp:TextBox>
                                    <asp:CustomValidator 
                                        ID="validarcorreoemp" 
                                        runat="server" 
                            ...
                            <div style="margin-top:10px">
                                ...
                                <div class="col-md-3">
                                    <asp:TextBox ID="nombreemp" runat="server" TextMode="SingleLine" Width="230px" MaxLength="30"></asp:TextBox>
                                    <asp:CustomValidator 
                                        ID="validarnombreemp" 
                                        runat="server" 
                            ...
                            <div>
                                ...
                                <div class="col-md-3">
                                    <asp:TextBox ID="apellidoemp" runat="server" TextMode="SingleLine" Width="230px" MaxLength="30"></asp:TextBox>
                                    <asp:CustomValidator 
                                        ID="valapellido" 
                                        runat="server" 
                            ...
                            <div>
                                ...
                                <div class="col-md-3">
                                    <asp:TextBox ID="contrasenaemp" runat="server" TextMode="Password" Width="230px" MaxLength="30"></asp:TextBox>
                                    <asp:CustomValidator 
                                        ID="valcontrasena" 
                                        runat="server" 
                            ...
                            <div>
                                ...
                                <div class="col-md-3">
                                    <asp:TextBox ID="verificarcontrasenaemp" runat="server" TextMode="Password" Width="230px" MaxLength="30"></asp:TextBox>
                                    <asp:CustomValidator 
                                        ID="valvacontrasena" 
                                        runat="server" 
                        ...
                        <div class="col-lg-12" style="margin-top:30px">
                            <div style="text-align:right" class="col-md-6">
                               <asp:Button ID="aceptaremp" runat="server" Text="Modificar" class="" OnClick="aceptaremp_Click" />
                            </div>
