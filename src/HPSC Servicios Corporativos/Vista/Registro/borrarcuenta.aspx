...
<body id="page-top">
    ...
    <section class="bg-gray" id="formulario" style="background-image: url('assets/img/registro-bg.jpg');background-size:100% 100vh;background-repeat:no-repeat;height:736px">
        <div class="container text-center wow fadeIn">
            <div class="row">
                <div class="col-lg-12">
                    <h2 style="color:white">Eliminación de cuenta</h2>
                </div>
            </div>
                            ...
                            <div style="margin-top:10px">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <asp:CustomValidator 
                                        ID="CustomValidator1" 
                                        runat="server" 
                                        ClientValidationFunction="CustomValidator1" 
                        ...
                        <style>
                         ...
                         <div class="col-lg-12" style="margin-top:20px">
                            <div style="text-align:right" class="col-md-6">
                               <asp:Button ID="aceptaremp" runat="server" Text="Eliminar" class="" OnClick="aceptaremp_Click"  />
                            </div>
