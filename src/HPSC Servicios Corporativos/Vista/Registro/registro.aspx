            ...
            <div class="inner-bg">
                <div class="container" >
                    ...
                    <div style="width:40%;margin:0 auto">
                        <asp:RadioButtonList ID="tipousuario" runat="server" Width="100%" RepeatDirection="Horizontal" TextAlign="Right" Font-Names="Raleway Black"  AutoPostBack="True" style="margin-bottom:-50px;margin-top:25px" OnSelectedIndexChanged="tipousuario_SelectedIndexChanged" ForeColor="White">
                                <asp:ListItem>Empleado</asp:ListItem>
                                <asp:ListItem>Cliente</asp:ListItem>
                                <asp:ListItem>Aliado</asp:ListItem>
                        </asp:RadioButtonList>
                        <asp:Panel id="formemp" runat="server" Visible="False">
                            <div class="form-box">
                        ...
                        <asp:Panel id="cliform" runat="server" Visible="False">
                             <div class="form-box">
	                             <div class="form-bottom" >
				                    <div class="form-group">
				                        <label class="sr-only" for="form-email">Email</label>
