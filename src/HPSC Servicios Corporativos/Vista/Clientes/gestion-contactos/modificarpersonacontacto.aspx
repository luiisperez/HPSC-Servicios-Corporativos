<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modificarpersonacontacto.aspx.cs" Inherits="HPSC_Servicios_Corporativos.Vista.Clientes.gestion_contactos.modificarpersonacontacto" %>
                        ...
                        <div class="col-xs-12">
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12" style="margin-top:30px;margin-left:50px">
                                        <div class="col-xs-6">
				                            <input type="text" class="form-control" id="estatus" runat="server" maxlength="18" style="width:70%;height:30px" visible="false">
                                        </div>
                                    </div>
                                </div>
                            </div>
