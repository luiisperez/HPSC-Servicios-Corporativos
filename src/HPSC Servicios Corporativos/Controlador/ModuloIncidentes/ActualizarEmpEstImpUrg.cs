...
{
    public class ActualizarEmpEstImpUrg:Comando
    {
        String correo;
        String est;
        String imp;
        String urg;
        String id;
        public ActualizarEmpEstImpUrg(String _correo, String _est, String _imp, String _urg, String _id)
        {
            this.id = _id;
            this.correo = _correo;
            this.est = _est;
        ...
        public override void ejecutar()
        {
            try
            {
                ...
                basedatos.ActualizarEmpEstImpUrg(correo, est, imp, urg, id);
            }
            catch (Exception ex)
            {
                throw ex;
