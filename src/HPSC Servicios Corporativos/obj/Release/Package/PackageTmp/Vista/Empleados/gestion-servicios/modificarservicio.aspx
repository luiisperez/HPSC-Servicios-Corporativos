<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modificarservicio.aspx.cs" Inherits="HPSC_Servicios_Corporativos.Vista.Empleados.gestion_servicios.modificarservicio" %>
                            ...
                            <div class="box-body">
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="margin-top:30px;margin-left:50px">
                                            ...
                                            <div class="col-xs-6">
                                                ...
                                                <asp:RadioButtonList ID="feriados_si_no" runat="server" Width="25%" RepeatDirection="Horizontal" TextAlign="Right" style="margin-top:3px">
                                                    <asp:ListItem Value="Sí" Selected="True">Sí</asp:ListItem>
                                        ...
                                        <div class="col-md-12" style="margin-top:30px;margin-left:50px">
                                            <div class="col-xs-6">
                                                <label style="text-align:right">Disponibilidad: </label>
                                                <asp:DropDownList ID="disponibilidad" runat="server" class="form-control" Height="30px" Width="70%">
