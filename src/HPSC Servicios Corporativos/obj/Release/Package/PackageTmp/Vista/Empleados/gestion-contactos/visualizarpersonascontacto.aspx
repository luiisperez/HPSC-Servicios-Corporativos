<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="visualizarpersonascontacto.aspx.cs" Inherits="HPSC_Servicios_Corporativos.Vista.Empleados.gestion_contactos.visualizarpersonascontacto" %>
                                                 ...
                                                 <asp:Repeater ID="repPeople" runat="server" OnItemCommand="repPeople_ItemCommand">
                                                    <ItemTemplate>
                                                            <tr id="<%# Eval("correo") %>">
                                                                ...
                                                                <td><asp:Label ID="identificador" runat="server" Text='<%# Eval("correo") %>' ReadOnly="True" BorderStyle="None" /></td>
                                                                <td><%# Eval("telfmovil") %></td>
                                                                <td><%# Eval("telflocal") %></td>
                                                                <td><%# Eval("cliente") %></td>
                                                                <td><%# Eval("estatus") %></td>
                                                                <td style="text-align:center">
                                                                    <asp:ImageButton ID="Eliminar" runat="server" Text="Eliminar" ImageUrl="~/Vista/Common/img/eliminar.ico" Height="25px" Width="25px" ToolTip="Eliminar" />
                                                                    <asp:ImageButton ID="Modificar" runat="server" Text="Eliminar" ImageUrl="~/Vista/Common/img/modificar.ico" Height="25px" Width="25px" ToolTip="Modificar" />
                                                                </td>
                                                            </tr>              
                                                    </ItemTemplate>
                                                 </asp:Repeater>
